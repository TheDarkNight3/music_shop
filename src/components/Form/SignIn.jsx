...
const SignIn = ({setAuthenticationWay}) => {
        ...
        <div className="form-container">
            ...
            <form action="" className='form' onSubmit={submitHandler}>
                <div className="form-input">
                    ...
                    <input type='email' placeholder='Email' required value={inputData.email} onChange={emailHandler}/>
                </div>
                <div className="form-input">
                    <span className="form-input__icon">{passwrodIcon}</span>
                    <input type='password' placeholder='Password' required value={inputData.password} onChange={passwordHandler}/>
                </div>
                {
                ...
                <div className="button-container">
                    ...
                    <button className='common-button' type='submit'>Sign in</button>
                    <span className='button-container__btn-description'>Didn't have any account? 
                        <button className='text-button-colored' onClick={() => setAuthenticationWay("SignUp")} >Sign Up here</button>
                    </span>
